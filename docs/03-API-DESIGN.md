...
**Response:** Full product object including editorial, curator write-up, variants, specs, and reviews summary.
...
`?category=kitchen&sort=reputation`
...
List orders for vendor products.
...
{
  "status": "rejected",
  "feedback": "Image quality below standard. Please resubmit with studio photos."
}
```
...
| Event | Handler |
|---|---|
| payment_intent.succeeded | Confirm order and trigger fulfillment |
| payment_intent.payment_failed | Mark order failed and notify buyer |
| charge.refunded | Process refund and update inventory |
