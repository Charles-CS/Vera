...
export const metadata: Metadata = {
  ...
  description: "Please read our terms of service carefully before using the Vera plant and mushroom identification platform. Understand our limitations of liability and disclaimers.",
  openGraph: {
    title: "Terms of Service | Vera",
    description: "Please read our terms of service carefully before using the Vera plant and mushroom identification platform.",
  },
};
